package com.dev.samples.sample.ui.widgets
...
import com.dev.samples.sample.theme.ShimmerColorShades


@Composable
fun ShimmerEffectScreen() {
    SampleOverAllTheme(darkTheme = false) {
...
@Composable
fun ShimmerEffectScreenPreview() {
    ShimmerEffectScreen()
}
